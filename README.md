...
> **Инструкция по сверке грузов** — запуск, структура папок, промпты через `.env`, перевозчики, разбор ошибок и таймаутов:
> [`Сверка грузов - инструкция.html`](Сверка%20грузов%20-%20инструкция.html) (открывается в браузере)
